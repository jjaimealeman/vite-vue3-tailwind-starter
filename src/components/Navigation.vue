...
<template>
	<Disclosure as="nav" class="bg-gradient-to-b from-gray-600 to-gray-800" v-slot="{ open }">
			...
			<div class="relative flex h-16 items-center justify-between">
				...
				<div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
					<div class="flex flex-shrink-0 items-center">
						<img class="block h-8 w-auto lg:hidden" src="./vite-starter-logo.min.svg" alt="Workflow" />
						<img class="hidden h-8 w-auto lg:block" src="./vite-starter-logo-plus.min.svg" alt="Workflow" />
					</div>
